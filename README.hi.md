...
1) दर्ज करें`flask_app`निर्देशिका:`$ cd flask_app`2) भागो`pip install -r requirements.txt`
3) If non-existent, create a virtual environment inside the `flask_app`निर्देशिका:`python3 -m venv .venv`4) आभासी वातावरण प्रारंभ करें और दर्ज करें:`. .venv/bin/activate`

...
3) Start the virtual environment and enter: `. .venv/bin/activate`4) Set the Flask App to app directory:`exporter FLASK_APP=application`5) Set the Flask Environment to development:`export FLASK_ENV=développement`6) Run the flask app:`analyse du flacon\`\`\`
